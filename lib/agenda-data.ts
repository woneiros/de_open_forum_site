  ...
  },
  {
    ...
    speakers: [
      ...
      },
      {
        ...
        bio: "Vikram Koka is Chief Strategy Officer at Astronomer and a member of the Apache Airflow PMC, with a deep passion for data and open-source data orchestration. He has been a key contributor to Airflow since its early evolution, beginning with Scheduler High Availability in Airflow 2.0 and shaping its future through architectural leadership and design contributions across initiatives such as Data-Driven Scheduling, Dynamic Tasks, Setup/Teardown, and Airflow 3. Vikram’s open-source roots trace back to his early work on the GNU Debugger (GDB), where he co-developed its remote debugging capabilities. With patents in distributed computing and cryptography, he brings a strong technical foundation alongside extensive experience leading large, globally distributed engineering and cross-functional teams spanning R&D, UX, product, services, and business development, and he thrives at the intersection of enterprise innovation and open-source community collaboration.",
      },
      {
        name: "Laura Pruitt",
    ...
    abstract:
      "<p>Data has never been more important to the enterprise—or more visible. As intelligent agents reshape how we create, move, and trust information, the boundaries of data engineering are shifting fast. This breakout brings together industry luminaries for a candid, forward-looking conversation about the craft's next chapter: from human dashboards to autonomous workflows, from schemas to semantics, from pipelines to products.</p><p>We'll dig into:</p><ul><li><b>The evolution of the data engineer:</b> from moving bytes to governing meaning</li><li><b>Semantic contracts and accountability:</b> where responsibility lives when meaning gets lost in translation</li><li><b>Open knowledge vs. black boxes:</b> the future of standards in an AI-first ecosystem</li><li><b>The 24-month pivot:</b> the single skill to bet on as SQL and ETL automate away</li><li><b>Language wars:</b> the best specs for aligning data teams with business partners and intelligent assistants.</li><li><b>Trustworthy AI systems:</b> the role data engineers play in ensuring AI remains reliable, grounded in truth, and aligned to the wellbeing of humanity</li></ul><p>If you're building with data—or building your career on it—this session will cut through the hype and offer practical, inspiring guidance on how to stay relevant, resilient, and impactful in the era of self-managing systems.</p>",
  },
  {
    id: "s21",
    start: "16:45",
